...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getCurrentUsersName = function () {
        return this.http.get(API_URL + '/user/username').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            var name = response.json();
            console.log("Name from userService" + name);
            return name;
        }));
    };
